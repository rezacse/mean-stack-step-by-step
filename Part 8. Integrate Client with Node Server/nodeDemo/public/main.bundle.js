...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_app_http_service__ = __webpack_require__("../../../../../src/app/services/app-http.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_12__services_app_http_service__["a" /* AppHttpService */], __WEBPACK_IMPORTED_MODULE_13__services_auth_service__["a" /* AuthService */]],
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(formBuilder, authService, router) {
        ...
        this.router = router;
        this.user = new __WEBPACK_IMPORTED_MODULE_1__models_login_model__["a" /* LoginModel */]();
        this.hide = true;
    }
...
module.exports = "<mat-toolbar color=\"primary\">\n  <mat-toolbar-row>\n    <button mat-button routerLink=\"/\">App Name </button>\n    \n    <span class=\"spacer\"></span>\n    <button mat-button routerLink=\"/register\">Register</button>\n    <button mat-button routerLink=\"/login\">Login</button>\n  </mat-toolbar-row>\n</mat-toolbar>\n"
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(formBuilder, authService, router) {
        ...
        this.authService = authService;
        this.router = router;
        this.user = new __WEBPACK_IMPORTED_MODULE_1__models_register_model__["a" /* RegisterModel */]();
        this.hide = true;
    }
...
var AppHttpService = /** @class */ (function () {
    ...
    AppHttpService.prototype.getHeaders = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        // TODO: add token
        return headers;
    };
    AppHttpService.prototype.getRequestOptions = function () {
        var options = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["d" /* RequestOptions */]();
        options.headers = this.getHeaders();
        return options;
    };
    AppHttpService.prototype.get = function (url) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_http_service__ = __webpack_require__("../../../../../src/app/services/app-http.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthService = /** @class */ (function () {
    ...
    AuthService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["C" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__app_http_service__["a" /* AppHttpService */]])
    ], AuthService);
    return AuthService;
}());
